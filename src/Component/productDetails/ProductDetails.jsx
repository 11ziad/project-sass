...
<Helmet>
  ...
  {detailsData.map((category)=><> <h1 className={`${style.styleMain} mt-10  text-orange-500`}>{category.strIngredient1}</h1>
        ...
        <div className=" lg:w-1/3 mt-10">
         ...
         <a className='ps-5 pe-5 pt-2 pb-2 me-4 bg-red-500 text-white  rounded-md' href={category.strYoutube}> <span className='me-2'><i className="fa-brands fa-youtube"></i></span>Youtube</a>
            <a className='ps-5 pe-5 pt-2 pb-2 bg-green-500 text-white rounded-md' href={category.strSource}><span><i className="fa-solid fa-globe"></i></span> Source</a>
          </div>
        </div>

        <div className="w-full md:w-full lg:w-1/3 mt-10 ps-6">
            <p>{category.strInstructions}</p>          
        </div>
        <div className="w-full m-auto md:w-full lg:w-1/3 mt-10 ps-3">
