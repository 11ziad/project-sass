...
export default function Area(){
  ...
  return <>
       ...
       <h1 className={`${style.styleText} p-7 mt-9 md:mt-0`}>Learn, Cook, Eat Your Food</h1>
...
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        {close===true ?
        <ul className=' w-full bg-white mt-7 rounded-2xl md:hidden text-center relative py-3' >
          ...
          {namesCategory.map((cat,indix)=> <div key={indix}>
    <li onClick={()=>{
