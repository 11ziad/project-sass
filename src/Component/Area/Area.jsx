...
export default function Area(){
  ...
  animate = "visible"
    className="relative">
        ...
        <NavLink to={'/search'}>
        <input name='search' type="search" id="search" className="block w-full p-2.5 ps-10 lg:p-3.5 lg:ps-10 text-sm text-gray-900 border focus:outline-none border-gray-300 rounded-lg bg-gray-50" placeholder="Search Mockups, Logos..." required />
        </NavLink>
    </motion.div>
</form>
