...
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        initial = "hidden"  
        animate = "visible"
        className=' w-full bg-white mt-7 rounded-md md:hidden pt-8 text-center relative py-3' >
          ...
          {namesCategory.map((cat)=> <div onClick={()=>{setClose(false)}}  key={cat.idCategory}>
    <li onClick={()=>{
    ...
    {cat.strCategory}
      ...
      <motion.ul 
        ...
        initial = "hidden"  
        animate = "visible"
      className=' hidden ps-7 pe-11 md:flex gap-y-3 flex-wrap'>
